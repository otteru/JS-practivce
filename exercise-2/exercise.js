...
function firstOutput(event){
	//console.dir(firstButton);
	thirdParagraph.remove();
}

function secondOutput(event){
...
firstButton.addEventListener("click", firstOutput);
secondButton.addEventListener("click", secondOutput);
...
//const thirdParagraph = document.body.children[2].children[5];
